...
class PauseSubState extends MusicBeatSubstate
{
	...
	function getPauseSong()
	{
		...
		var formattedPauseMusic:String = ClientPrefs.data.pauseMusic == 'Breakfast' ? Paths.formatToSongPath('pausemenu') : Paths.formatToSongPath(ClientPrefs.data.pauseMusic);
