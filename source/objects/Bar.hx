...
class Bar extends FlxSpriteGroup
{
	...
	public function updateBar()
	{
		...
		// so the time bar doesn't fuck up
		if (image == 'healthBar') FlxGradient.overlayGradientOnFlxSprite(leftBar, Std.int(leftBar.width), Std.int(leftBar.height), [leftBar.color, rightBar.color], 0, 0, 1, 180, true);
	}
